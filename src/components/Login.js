...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form onSubmit={getInputData} className='absolute flex flex-col left-0 right-0 mx-auto w-3/12 my-36 items-center justify-center bg-black p-12 opacity-90 rounded-md'>
        <div className='flex flex-col items-center'>
          ...
          <button className='text-white bg-red-600 mt-4 p-3 px-[6.4vw] rounded-sm font-bold'>{isLogin? "Login" : "Signup"}</button>
